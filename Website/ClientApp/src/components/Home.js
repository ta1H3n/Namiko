...
export class Home extends Component {
  ...
  render () {
    return (
        <div>
            <img src="images/banner.png" height="auto" width="1080" />
            ...
            <ol>
                <li><a href="#waifus">Waifus</a></li>
                <li><a href="#banroulette">Banroulette</a></li>
                <li><a href="#user-profile">User Profile</a></li>
                <li><a href="#currency-and-gambling">Currency &amp; Gambling</a></li>
                <li><a href="#reaction-images">Reaction Images</a></li>
                <li><a href="#teams">Teams</a></li>
                <li><a href="#server-settings">Server Settings</a></li>
                <li><a href="#web-commands">Web Commands</a></li>
